...
(function initShellRouter() {
  ...
  const routes = {
    ...
    '/chat': { route: 'chat', view: 'chat', title: 'Glide Bedside - Assistant', mount: null },
    '/app/chat': { route: 'chat', view: 'chat', title: 'Glide Bedside - Assistant', mount: null },
    ...
    '/account': { route: 'account', view: 'settings', title: 'Glide Bedside - Account', mount: 'GlideSettingsView', viewKey: 'account' },
