# Glide Bedside v1.1.1 Release Receipt
...
- Task: `Add versioning to Glide Bedside web app and Alexa skill` (`48f4972b-da19-4ec6-929e-cec4f558a77b`)
...
```json
{"name":"smart-patient-tracker","version":"1.1.1","release":"v1.1.1","environment":"development","commit":"<current deployed commit or null for local upload>","builtAt":"2026-05-11T15:11:59Z","components":{"webApp":{"name":"smart-patient-tracker","version":"1.1.1"},"alexaSkill":{"name":"Glide Bedside","invocationName":"fluid tracking","version":"1.1.1"}}}
```
...
```xml
<speak>Glide Bedside is running version 1.1.1.</speak>
```
